  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {localStorage.getItem('token') ? <Route path="/profile/series" element={<SeriesHistory />} /> : null}
        {localStorage.getItem('token') ? <Route path="/profile/" element={<Profile />} /> : null}
        {localStorage.getItem('token') ? <Route path="/friends/" element={<Friends />} /> : null}
        {localStorage.getItem('token') ? <Route path="/friends/add" element={<SearchFriends />} /> : null}
      </Routes>
    </BrowserRouter>
