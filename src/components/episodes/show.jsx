...
export default function ShowEpisode() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.betaseries.com/episodes/display?client_id=${process.env.REACT_APP_APIKEY}&id=${id}`
      )
        ...
        <div className=" p-4">
          ...
          <div className="mt-2 flex flex-col items-center md:items-stretch lg:flex-row">
            <div className="flex flex-col mr-4">
              <img
                src={`https://api.betaseries.com/pictures/episodes?client_id=${process.env.REACT_APP_APIKEY}&id=${id}&width=500&height=282`}
                alt=""
